      ...
      <aside className="w-64 shrink-0 glass border-r border-warmGray/20 flex flex-col py-8 px-5 gap-8">
              ...
              className={({ isActive }) =>
                clsx(
                  ...
                  isActive
                    ...
                    : "text-warmGray-dark hover:bg-terra/8 hover:text-terra",
                )
              }
            >
              <Icon size={18} />
        ...
        <div className="border-t border-warmGray/20 pt-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 w-full rounded-xl text-sm text-warmGray hover:text-terra hover:bg-terra/8 transition-all"
          >
